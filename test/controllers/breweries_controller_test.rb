...
class BreweriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post breweries_url, params: { brewery: { address: @brewery.address, description: @brewery.description, name: @brewery.name, website: @brewery.website } }, as: :json
    end
  ...
  test "should update brewery" do
    patch brewery_url(@brewery), params: { brewery: { address: @brewery.address, description: @brewery.description, name: @brewery.name, website: @brewery.website } }, as: :json
    assert_response 200
  end
